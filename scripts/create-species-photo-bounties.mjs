...
5. Comment on MergeOS [Claim Token #1](https://github.com/mergeos-bounties/mergeos/issues/1) with this issue link  
6. Open a PR to **PlantGuide** with \`Fixes #<this-issue>\`
